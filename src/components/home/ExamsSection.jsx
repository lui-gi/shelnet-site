    ...
    <section id="exams" className="py-24 px-6 relative bg-black border-t border-white/5 z-[1]">
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        <div className="grid lg:grid-cols-2 gap-6">
           ...
           {/* A+ Exam */}
           <Link to="/a-plus-exams" className="block border border-red-500/30 bg-red-500/[0.08] backdrop-blur-sm shadow-lg shadow-red-500/15 hover:shadow-red-500/25 hover:bg-red-500/[0.13] transition-all duration-300 p-8 flex flex-col justify-between rounded-lg relative overflow-hidden cursor-pointer">
              {/* Glass sheen */}
              ...
              <div className="border border-red-500/15 bg-black/60 backdrop-blur-sm p-4 font-mono text-sm rounded">
                 ...
                 <span className="block w-full border border-red-600 bg-red-500/10 text-white hover:bg-red-500/20 hover:text-red-400 font-bold py-3 px-4 transition-all text-center uppercase btn-scanline rounded">
                   Launch Exams
                 </span>
              </div>
           </Link>
           ...
           {/* Sec+ Exam */}
           <Link to="/security-plus-exams" className="block border border-blue-500/30 bg-blue-500/[0.08] backdrop-blur-sm shadow-lg shadow-blue-500/15 hover:shadow-blue-500/25 hover:bg-blue-500/[0.13] transition-all duration-300 p-8 flex flex-col justify-between rounded-lg relative overflow-hidden cursor-pointer">
              {/* Glass sheen */}
              ...
              <div className="border border-blue-500/15 bg-black/60 backdrop-blur-sm p-4 font-mono text-sm rounded">
                 ...
                 <span className="block w-full border border-blue-600 bg-blue-500/10 text-white hover:bg-blue-500/20 hover:text-blue-400 font-bold py-3 px-4 transition-all text-center uppercase btn-scanline rounded">
                    Launch Exams
                  </span>
              </div>
           </Link>

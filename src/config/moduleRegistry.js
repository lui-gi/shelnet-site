...
export const MODULES = [
  ...
  { slug: 'pcap-wireshark', name: 'PCAP & Wireshark', category: 'detection', difficulty: 'core',
    stageKind: 'pcap', status: 'live',
    blurb: 'Read a capture the way an analyst reads it.',
    load: () => import('./modules/pcap-wireshark.js') },

...
const Layout = () => {
  ...
  useEffect(() => {
    // Intentional: reset mobile drawer on route change (navigation event).
  ...
  return (
    <div className="min-h-screen bg-black text-white font-mono selection:bg-emerald-500/30 selection:text-emerald-200 relative">
      {/* NAVBAR */}
        ...
        <div className="max-w-7xl mx-auto px-6 flex justify-between items-center">
          <div className="flex items-center gap-4">
            <a
              ...
              className="flex items-center gap-3 cursor-pointer hover:text-emerald-500 transition-colors"
            >
          ...
          <button
            ...
            className="md:hidden text-white hover:text-emerald-500 transition-colors p-2"

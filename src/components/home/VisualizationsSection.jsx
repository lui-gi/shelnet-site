  ...
  return (
    <section id="visualizations" className="py-24 px-6 relative bg-black border-t border-white/5 z-[1]">
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        {/* Single Card */}
        <Link to="/visualizations" className="block border border-purple-500/30 bg-purple-500/[0.08] backdrop-blur-sm shadow-lg shadow-purple-500/15 hover:shadow-purple-500/25 hover:bg-purple-500/[0.13] transition-all duration-300 p-8 flex flex-col justify-between rounded-lg relative overflow-hidden cursor-pointer">
            {/* Glass sheen */}
            ...
            <div className="border border-purple-500/15 bg-black/60 backdrop-blur-sm p-4 font-mono text-sm rounded">
              ...
              <span className="block w-full border border-purple-600 bg-purple-500/10 text-white hover:bg-purple-500/20 hover:text-purple-400 font-bold py-3 px-4 transition-all text-center uppercase btn-scanline rounded">

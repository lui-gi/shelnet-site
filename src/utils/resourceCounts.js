 ...
 * { certs, pbqs, exams, quizzes, viz, labs, bytes }. A count is null when its source data is
...
export function deriveCounts(manifest) {
  ...
  if (!certs) {
    return { certs: null, pbqs: null, exams: null, quizzes: null, viz: null, labs: COMING_LABS.length, bytes: null };
  }
